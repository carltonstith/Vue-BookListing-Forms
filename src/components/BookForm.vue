<template>
  <form v-on:submit.prevent="bookSubmit(bookData)" class="" action="#" method="post">
    ...
    <div>
      ...
      <input v-model="bookData.finishedReading" type="checkbox" name="" value="">
      <label for="borrowed">Borrowed</label>
      <input v-model="bookData.ownership" type="radio" name="" value="borrowed">
      <label for="bought">Bought</label>
      <input v-model="bookData.ownership" type="radio" name="" value="bought">
    </div>
